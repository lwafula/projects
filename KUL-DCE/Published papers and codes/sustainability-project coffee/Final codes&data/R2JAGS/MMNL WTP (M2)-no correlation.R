...
############                  30-07-2018 by LMaaya
############                  MMNL[M2] MODEL-WTP SPACE #############################
###########                   DIC calculation ##############
...
# script with initial data management for WINBUGS
datamcoffeewinbugs <- parse("scripts/BUGS/models with all sets=6, different by blocks/winbugs_data_preparation code_set=6.R") 
...
cat("model{
    ...
    file="C:/KU_Leuven/DCE/project_coffee/scripts/WINBUGS/R2JAGS/MMNL2WTP.jags")
...
m2 <- R2jags::jags(data = mmnldcof, inits = inits, mmnl2par, n.chains = 3, n.iter = 100000, n.burnin = 50000,n.thin=1, 
                   model.file = "C:/KU_Leuven/DCE/project_coffee/scripts/WINBUGS/R2JAGS/MMNL2WTP.jags")
