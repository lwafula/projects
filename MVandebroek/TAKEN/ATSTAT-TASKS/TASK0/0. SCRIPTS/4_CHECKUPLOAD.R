...
olduser_info <- read.csv("1.FILES\\olduser_info_TASK0.csv",
                         check.names = F)

group_info = read_xlsx("1.FILES\\user_info with coding_TASK0.xlsx") |>
...
for (i in 1:length(group_IDS)){
  ...
  if (LABEL == "TSTAT") {
    ...
    dataquizfeedpath = paste0("<p>Click <a href=", 'https://feb.kuleuven.be/public/', personID,'/TASK0/1.DATA/data',dfUPLOAD[i,'newid'],'.txt',">here for your data</a></p>",
                          "<p>Click <a href=", 'https://feb.kuleuven.be/public/', personID,'/TASK0/2.QUESTIONS/vragen',dfUPLOAD[i,'newid'],'.txt',">here for your questions</a></p>",
                          "<p>Click <a href=", 'https://feb.kuleuven.be/public/', personID,'/TASK0/3.FEEDBACK/feedback',dfUPLOAD[i,'newid'],'.txt',">here for your feedback</a></p>")
    # for the sharedFolder
    # dataquizfeedpath = paste0("<p>Click <a href=", sharedFolder,'/TASK0/2.INDIVIDUAL/1.DATA/data',dfUPLOAD[i,'newid'],'.txt',">here for your data</a></p>",
    #                       # "<p></p>", 
    #                       "<p>Click <a href=", sharedFolder,'/TASK0/2.INDIVIDUAL/2.QUESTIONS/vragen',dfUPLOAD[i,'newid'],'.txt',">here for your questions</a></p>")
    # 
    ...
    # the public link points to the W: drive
    dataquizfeedpath = paste0("<p>Click <a href=", 'https://feb.kuleuven.be/public/', personID,'/TASK0/1.DATA/data',dfUPLOAD[i,'newid'],'.txt',">here for your data</a></p>",
                          "<p>Click <a href=", 'https://feb.kuleuven.be/public/', personID,'/TASK0/2.QUESTIONS/questions',dfUPLOAD[i,'newid'],'.txt',">here for your questions</a></p>",
                          "<p>Click <a href=", 'https://feb.kuleuven.be/public/', personID,'/TASK0/3.FEEDBACK/feedback',dfUPLOAD[i,'newid'],'.txt',">here for your feedback</a></p>")
...
write.table(dfUPLOAD, file = "1.FILES\\CHECKUPLOADFILE_TASK0.csv", 
            sep = ',', row.names = F)