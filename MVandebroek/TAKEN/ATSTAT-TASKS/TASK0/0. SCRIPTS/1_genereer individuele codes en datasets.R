...
group_info = read.csv("1.FILES\\group info_TASK0.csv", check.names = F)
...
write.xlsx(user_info,"1.FILES\\user_info with coding_TASK0.xlsx")
...
for(i in 1:I){
  ...
  indfolder= paste0("W:\\TASK0\\1.DATA")
