...
olduser_info <- read.csv("1.FILES\\olduser_info_TRYOUT.csv",
                         check.names = F)

group_info = read_xlsx("1.FILES\\user_info with coding_TRYOUT.xlsx") |>
...
for (i in 1:length(group_IDS)){
  ...
  if (LABEL == "TSTAT") {
    ...
    dataquizpath = paste0("<p>Click <a href=", sharedFolder,'/TRYOUT/2.INDIVIDUAL/1.DATA/data',dfUPLOAD[i,'newid'],'.txt',">here for your data</a></p>",
                          # "<p></p>", 
                          "<p>Click <a href=", sharedFolder,'/TRYOUT/2.INDIVIDUAL/2.QUESTIONS/vragen',dfUPLOAD[i,'newid'],'.txt',">here for your questions</a></p>")
    ...
    dataquizpath = paste0("<p>Click <a href=", sharedFolder, '/TRYOUT/2.INDIVIDUAL/1.DATA/data',dfUPLOAD[i,'newid'],'.txt',">here for your data</a></p>",
                          # "<p></p>", 
                          "<p>Click <a href=", sharedFolder, '/TRYOUT/2.INDIVIDUAL/2.QUESTIONS/questions',dfUPLOAD[i,'newid'],'.txt',">here for your questions</a></p>")
...
write.table(dfUPLOAD, file = "1.FILES\\CHECKUPLOADFILE_TRYOUT.csv", 
            sep = ',', row.names = F)