...
getDATA <- function(ID){
  ...
  WD <- paste0("C:\\Users\\",personID,"\\OneDrive - KU Leuven\\ATSTAT-TASKS\\Individualized TASKS\\2.INDIVIDUAL\\")
...
gradingTOOL <- function(responses, solutions){
  ...
  for (i in 1:length(group_IDS)){
   ...
   feedbacktext = rbind(c("Question", "Your answer", "Correct answer", "Grade"),
    ...
    indfolder= paste0("W:\\IndividualizedTASKS\\3.FEEDBACK")
