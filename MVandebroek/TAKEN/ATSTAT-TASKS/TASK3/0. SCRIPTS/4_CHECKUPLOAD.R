...
for (i in 1:length(group_IDS)){
  ...
  if (LABEL == "TSTAT") {
    ...
    dataquizfeedpath = paste0("<p>Click <a href=", 'https://feb.kuleuven.be/public/', personID,'/TASK3/1.DATA/data',dfUPLOAD[i,'newid'],'.txt',">here for your data</a></p>",
    ...
    # dataquizfeedpath = paste0("<p>Click <a href=", sharedFolder,'/TASK3/2.INDIVIDUAL/1.DATA/data',dfUPLOAD[i,'newid'],'.txt',">here for your data</a></p>",
    #                       # "<p></p>", 
    #                       "<p>Click <a href=", sharedFolder,'/TASK3/2.INDIVIDUAL/2.QUESTIONS/vragen',dfUPLOAD[i,'newid'],'.txt',">here for your questions</a></p>")
    # 
