...
olduser_info <- read.csv("1.FILES\\olduser_info_TASK3.csv", check.names = F) |> 
  filter(!((str_detect(tolower(`First Name`), "bert")|str_detect(tolower(`First Name`), "elia")) & str_detect(tolower(`Last Name`), "preview")))

group_info = read_xlsx("1.FILES\\user_info with coding_TASK3.xlsx") |>
...
for (i in 1:length(group_IDS)){
  ...
  if (LABEL == "TSTAT") {
    ...
    dataquizfeedpath = paste0("<p>Click <a href=", 'https://feb.kuleuven.be/public/', personID,'/TASK3/1.DATA/', dfUPLOAD[i,'newid'],'_data1.txt',">here for dataset1</a>",
                              " and <a href=", 'https://feb.kuleuven.be/public/', personID,'/TASK3/1.DATA/', dfUPLOAD[i,'newid'],'_data2.txt',">here for dataset2</a></p>",
                              "<p>Click <a href=", 'https://feb.kuleuven.be/public/', personID,'/TASK3/2.QUESTIONS/vragen',dfUPLOAD[i,'newid'],'.txt',">here for your questions</a></p>",
                              "<p>Click <a href=", 'https://feb.kuleuven.be/public/', personID,'/TASK3/3.FEEDBACK/',dfUPLOAD[i,'newid'],'_feedback.txt',">here for your feedback</a></p>")
    ...
    dataquizfeedpath = paste0("<p>Click <a href=", 'https://feb.kuleuven.be/public/', personID,'/TASK3/1.DATA/', dfUPLOAD[i,'newid'],'_data1.txt',">here for dataset1</a>",
                              " and <a href=", 'https://feb.kuleuven.be/public/', personID,'/TASK3/1.DATA/', dfUPLOAD[i,'newid'],'_data2.txt',">here for dataset2</a></p>",
                              "<p>Click <a href=", 'https://feb.kuleuven.be/public/', personID,'/TASK3/2.QUESTIONS/questions',dfUPLOAD[i,'newid'],'.txt',">here for your questions</a></p>",
                              "<p>Click <a href=", 'https://feb.kuleuven.be/public/', personID,'/TASK3/3.FEEDBACK/',dfUPLOAD[i,'newid'],'_feedback.txt',">here for your feedback</a></p>")
...
write.table(dfUPLOAD, file = "1.FILES\\CHECKUPLOADFILE_TASK3.csv", 
            sep = ',', row.names = F)
