...
for (i in 1:length(group_IDS)){
  ...
  if (LABEL == "TSTAT") {
    ...
    dataquizpath = paste0("<p>Click <a href=", 'https://feb.kuleuven.be/public/u0118298/dd', dfUPLOAD[i,'newid'], "\\TASK1",'/1. data',dfUPLOAD[i,'newid'],'.txt',">here for your data</a></p>",
                          # "<p></p>", 
                          "<p>Click <a href=", 'https://feb.kuleuven.be/public/u0118298/dd', dfUPLOAD[i,'newid'], "\\TASK1", '/2. vragen',dfUPLOAD[i,'newid'],'.txt',">here for your questions</a></p>",
                          "<p>Click <a href=", 'https://feb.kuleuven.be/public/u0118298/dd', dfUPLOAD[i,'newid'], "\\TASK1", '/3. feedback',dfUPLOAD[i,'newid'],'.txt',">here for your feedback</a></p>")
    ...
    dataquizpath = paste0("<p>Click <a href=", 'https://feb.kuleuven.be/public/u0118298/dd', dfUPLOAD[i,'newid'], "\\TASK1", '/1. data',dfUPLOAD[i,'newid'],'.txt',">here for your data</a></p>",
                          # "<p></p>", 
                          "<p>Click <a href=", 'https://feb.kuleuven.be/public/u0118298/dd', dfUPLOAD[i,'newid'], "\\TASK1", '/2. questions',dfUPLOAD[i,'newid'],'.txt',">here for your questions</a></p>",
                          "<p>Click <a href=", 'https://feb.kuleuven.be/public/u0118298/dd', dfUPLOAD[i,'newid'], "\\TASK1", '/3. feedback',dfUPLOAD[i,'newid'],'.txt',">here for your feedback</a></p>")
